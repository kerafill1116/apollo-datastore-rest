...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        final OAuth2Validator.ValidationResponse validationResponse = oAuth2Validator.validate(authorizationRequest);
    ...
    private void sendError(HttpServletResponse response, AuthorizationRequest authReq, OAuth2Validator.ValidationResponse validate)
            throws IOException {
