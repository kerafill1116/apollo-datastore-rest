...
public interface OAuth2Validator {
    ...
    enum ValidationResponse {
        ...
        UNAUTHORIZED_CLIENT("unauthorized_client", "The client_id is unknown", Response.Status.UNAUTHORIZED),
        ...
        private ValidationResponse(String value, String description) {
            this(value, description, Response.Status.BAD_REQUEST);
        }

        private ValidationResponse(String value, String description, Response.Status status) {
            this.value = value;
